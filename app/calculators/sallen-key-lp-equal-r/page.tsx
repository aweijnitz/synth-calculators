...
const DEFAULT_INPUTS: EqualResistorInputs = {
  c1: '4.7n',
  c2: '1n',
  rPotMax: '50k',
  rSeriesTop: '',
...
function SallenKeyEqualResistorContent() {
  ...
  const [inputs, setInputs] = React.useState<EqualResistorInputs>(() => ({
    c1: searchParams.get('c1') ?? DEFAULT_INPUTS.c1,
    c2: searchParams.get('c2') ?? DEFAULT_INPUTS.c2,
    rPotMax: searchParams.get('rpot') ?? DEFAULT_INPUTS.rPotMax,
    rSeriesTop: searchParams.get('rst') ?? DEFAULT_INPUTS.rSeriesTop,
    rSeriesBottom: searchParams.get('rsb') ?? DEFAULT_INPUTS.rSeriesBottom,
    mode: 'lowpass',
  }));
  ...
  return (
    <>
      <CalculatorHeader title="Sallen-Key LPF · Equal Resistors" />
