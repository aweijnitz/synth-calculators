...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={robotoFlex.variable}>
      ...
      <meta property="og:image" content="https://synthi-calc.expressive-circuits.com/img/synthi-calc-og-image.png"/>
      ...
      <meta name="twitter:image" content="https://synthi-calc.expressive-circuits.com/img/synthi-calc-og-image.png"/>
