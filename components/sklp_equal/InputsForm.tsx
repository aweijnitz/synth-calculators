...
const FIELD_LABELS: Record<Field, string> = {
  fcTarget: 'Target f_c @ 50%',
  rPotMax: 'Potentiometer Max (per gang)',
  cBase: 'Capacitor Seed (optional)',
};

const FIELD_HELPERS: Record<Field, string> = {
  fcTarget: 'Frequency; allow `k`, `M` (case-sensitive).',
  rPotMax: 'Ohms; allow `k`, `M` (case-sensitive).',
  cBase: 'Farads; allow `p`, `n`, `u`, `m`. Guides E6 selection.',
};

const ORDER: Field[] = ['fcTarget', 'rPotMax', 'cBase'];
